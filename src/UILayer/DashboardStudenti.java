package com.paradigmaprogramuese.ui;
...
public class DashboardStudenti {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DashboardStudenti window = new DashboardStudenti();
	...
	private void initialize() {
		...
		txtBlendarifajgmailcom.setText("blendarifaj@gmail.com");
